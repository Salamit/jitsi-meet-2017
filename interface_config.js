var interfaceConfig = { // eslint-disable-line no-unused-vars
    ...
    JITSI_WATERMARK_LINK: "https://remoteteachers.com",
    ...
    TOOLBAR_BUTTONS: [
        ...
        //extended toolbar
        'profile', 'addtocall', 'contacts', 'chat','audioonly', 'recording', 'etherpad', 'sharedvideo','sip', 'settings', 'raisehand', 'videoquality', 'filmstrip'], // jshint ignore:line
    /**
    ...
    //disable the ringing sound when the RingOverlay is shown.
    ...
    LIVE_STREAMING_HELP_LINK: "https://remoteteachers.com/live",

    /**
     * Whether the mobile app Jitsi Meet is to be promoted to participants
     * attempting to join a conference in a mobile Web browser. If undifined
     * default to  true
     *
     * @type {boolean}
     */
