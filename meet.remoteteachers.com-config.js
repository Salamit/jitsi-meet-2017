...
//    configLocation: './config.json', // see ./modules/HttpConfigFetch.js
    hosts: {
        domain: 'meet.remoteteachers.com',
        //anonymousdomain: 'guest.example.com',
        //authdomain: 'meet.remoteteachers.com',  // defaults to <domain>
        muc: 'conference.meet.remoteteachers.com', // FIXME: use XEP-0030
        //jirecon: 'jirecon.meet.remoteteachers.com',
        //call_control: 'callcontrol.meet.remoteteachers.com',
        //focus: 'focus.meet.remoteteachers.com', // defaults to 'focus.meet.remoteteachers.com'
    },
//  getroomnode: function (path) { return 'someprefixpossiblybasedonpath'; },
//  useStunTurn: true, // use XEP-0215 to fetch STUN and TURN server
//  useIPv6: true, // ipv6 support. use at your own risk
    useNicks: false,
    bosh: '//meet.remoteteachers.com/http-bind', // FIXME: use xep-0156 for that
    clientNode: 'http://jitsi.org/jitsimeet', // The name of client node advertised in XEP-0115 'c' stanza
    //focusUserJid: 'focus@auth.meet.remoteteachers.com', // The real JID of focus participant - can be overridden here
    ...
    desktopSharingChromeExtId:'mbbidboejaohlpbjifdlodenbldfpnec',
...
//    callStatsSecret: "", // Secret for callstats.io API
    callStatsID: "123", // Application ID for callstats.io API
    callStatsSecret: "qwe", // Secret for callstats.io API
//    callStatsCustomScriptUrl: "https://remoteteachers.com/wp-content/plugins/wp-jitsi-bridge/getStats.php",
    callStatsCustomScriptUrl: "https://remoteteachers.com/getStats.php",
    ...
    //backToP2PDelay: 5
    etherpad_base: 'https://meet.remoteteachers.com:9002/whiteboard/'
};
